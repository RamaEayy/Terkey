...
class Terkey:
  ...
  def banner(self):
      os.system('clear')
      print(f'{c}Terkey By Marsa{a}[{c}Termux Key{a}]'.center(68))
      print(f'{a}MarsaPjn'.center(53))
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://t.me/MarsaPjn'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
